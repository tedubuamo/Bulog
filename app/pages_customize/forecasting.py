...
def show():
    ...
    if uploaded_file is not None:
        ...
        model_choice = st.selectbox("Pilih Model Forecasting:", ["SARIMAX", "Holt-Winters", "Prophet", "Seasonal Naïve"])
        ...
        if model_choice == "SARIMAX":
            ...
            conf_int = np.column_stack([forecast_df.tail(steps_ahead)["yhat_lower"].values,
